...
# Generated at Tue Oct 29 17:37:26 2013
...
CUSTOM_CFLAGS = #--debug --no_debug_macros
  ...
  # Switch-ability:
  #   Non-switchable
CUSTOM_DEBUG_MODULES = INIT NVRAM SYSTEM KAL
  #means only init and nvram will apply --debug --no_debug_macros
...
# ------------------------------ HW and Project
# ------------------------------ LCD
LCD_MODULE = EASTAEON77_CU_JB_LCM
  # Description:
...
CUSTOM_OPTION += __CGLA__ __UICC_CHANNEL_SUPPORT__
...
COM_DEFS_FOR_EASTAEON77_CU_JB_LCM = EASTAEON77_CU_JB_LCM
