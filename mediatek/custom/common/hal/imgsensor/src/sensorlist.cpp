...
{
#if defined(NXSC301HS5K4EC_YUV)
    YUV_INFO(NXSC301HS5K4EC_SENSOR_ID, SENSOR_DRVNAME_NXSC301HS5K4EC_YUV, NULL), 
#endif 
...
#if defined(OV8825_MIPI_RAW)
	fprintf(stderr,"jacob test GetSensorInitFuncList OV8825_MIPI_RAW\n");
#endif

#if defined(MT9P017_MIPI_RAW)
	fprintf(stderr,"jacob test GetSensorInitFuncList MT9P017_MIPI_RAW\n");
#endif
