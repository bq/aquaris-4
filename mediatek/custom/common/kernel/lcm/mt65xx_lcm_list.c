...
//zhuoshineng end
extern LCM_DRIVER nt35510_lead_lcm_drv;
//fenggy add end
//zhaoshaopeng for i10 20130304 start
extern LCM_DRIVER nt35510_lead_lc_lcm_drv;
//zhaoshaopeng for i10 20130304 end
extern LCM_DRIVER otm8009a_lead_lcm_drv;
extern LCM_DRIVER ili9806_lead_dsi_lcm_drv;

LCM_DRIVER* lcm_driver_list[] = 
{ 
//zhaoshaopeng for i10 20130304 end
#if defined(OTM8009A_LEAD)
	&otm8009a_lead_lcm_drv,
#endif

#if defined(ILI9806_LEAD_DSI)
	&ili9806_lead_dsi_lcm_drv,
#endif
#if defined(HX8369)
	&hx8369_lcm_drv,
#endif
...
//zhuoshineng end
#if defined(NT35510_LEAD)
	&nt35510_lead_lcm_drv,
#endif
//zhaoshaopeng for i10 20130304 start
#if defined(NT35510_LEAD_LC)
	&nt35510_lead_lc_lcm_drv,
#endif
//zhaoshaopeng for i10 20130304 end
};
