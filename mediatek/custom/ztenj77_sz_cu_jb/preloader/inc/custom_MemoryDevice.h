...
//fenggy mask #define BOARD_ID                LENOVO77
#define BOARD_ID    EASTAEON  
//#define BOARD_ID    MT6577_EVB  
//fenggy mask #define CS_PART_NUMBER[0]       KMSJS000KM_B308
#define CS_PART_NUMBER[0]       SD5D28B_4G  
#define CS_PART_NUMBER[1]       H9TP32A8JDMCPR_KGM  
#define CS_PART_NUMBER[2]       KMKJS000VM_B309  
#define CS_PART_NUMBER[3]       KE4CN2L2HA8A2A 
#define CS_PART_NUMBER[4]		MT29PZZZ8D4WKFEW_18_W_6D4
//#define CS_PART_NUMBER[0]       H9TP33A8LDMCMR   
