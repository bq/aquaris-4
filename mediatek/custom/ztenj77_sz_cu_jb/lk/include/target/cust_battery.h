...
#define AC_CHARGER_CURRENT					Cust_CC_450MA	
...
//fenggy mask #define BACKLIGHT_KEY 10					// camera key
#define BACKLIGHT_KEY 8
...
#define BAT_NTC_10 1//zhaoshaopeng define this for i8 20120720
